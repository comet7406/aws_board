...
public class BoardController {
    ...
    public ResponseEntity<?> writeBoard(@Valid @RequestBody EditBoardReqDto writeBoardReqDto, BindingResult bindingResult) {
    ...
    public ResponseEntity<?> editBoard(@PathVariable int boardId, @Valid @RequestBody EditBoardReqDto editBoardReqDto, BindingResult bindingResult) {
